#!/bin/sh 
DEMO="Red Hat Cloud HR Onboarding Assets Demo"
AUTHORS="Phil Griffiths, Waqaas Kausar, Anthony Kesterton"
...
if [ -r $SRC_DIR/$BPMS ] || [ -L $SRC_DIR/$BPMS ]; then
	...
	echo Need to download $BPMS from https://developers.redhat.com/products/bpmsuite/download
	echo and place it in the $SRC_DIR directory to proceed...
	echo
	exit
fi
